...
#include "../../../../src/find-object/src/ros1/FindObjectROS.h"
...
void FindObjectROS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FindObjectROS *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FindObjectROS::staticMetaObject = { {
    &find_object::FindObject::staticMetaObject,
    qt_meta_stringdata_FindObjectROS.data,
    qt_meta_data_FindObjectROS,
    qt_static_metacall,
    nullptr,
    nullptr
} };
