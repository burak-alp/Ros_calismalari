...
#include "../../../../src/find-object/src/ros1/CameraROS.h"
...
void CameraROS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CameraROS *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CameraROS::staticMetaObject = { {
    &find_object::Camera::staticMetaObject,
    qt_meta_stringdata_CameraROS.data,
    qt_meta_data_CameraROS,
    qt_static_metacall,
    nullptr,
    nullptr
} };
